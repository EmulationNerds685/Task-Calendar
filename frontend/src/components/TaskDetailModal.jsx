      ...
      >
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: "18px", fontWeight: 700, color: "#1e1b4b", margin: 0, lineHeight: 1.3 }}>
              {task.title}
            </h2>
          </div>
          <button
        ...
        <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          {task.description && (
            <div>
              <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Description</p>
              <p style={{ fontSize: "13px", color: "#4b5563", margin: 0, lineHeight: 1.6 }}>{task.description}</p>
            </div>
          )}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
            {task.category && (
              <div>
                <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Category</p>
                <span style={{
                  fontSize: "12px", padding: "3px 10px", borderRadius: "6px",
                  background: "rgba(233,213,255,0.4)", color: "#7c3aed", fontWeight: 500,
            ...
            {task.estimatedTime && (
              <div>
                <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Est. time</p>
                <p style={{ fontSize: "13px", color: "#4b5563", margin: 0, fontWeight: 500 }}>{task.estimatedTime} min</p>
              </div>
            )}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
            {task.dueDate && (
              <div>
                <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Deadline</p>
                <p style={{ fontSize: "13px", color: "#4b5563", margin: 0, fontWeight: 500 }}>{dayjs(task.dueDate).format("MMM D, YYYY")}</p>
              </div>
            )}
            {task.scheduledDate && (
              <div>
                <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Assigned Slot</p>
                <p style={{ fontSize: "13px", color: "#6366f1", margin: 0, fontWeight: 700 }}>
          ...
          {assignees.length > 0 && (
            <div>
              <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 8px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Assigned to</p>
                ...
                {assignees.map((a, i) => {
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      background: "rgba(233,213,255,0.35)", border: "1px solid rgba(196,181,253,0.3)",
                    }}>
                      <div style={{
                      ...
                      <span style={{ fontSize: "12px", color: "#4c1d95", fontWeight: 500 }}>{name}</span>
                    </div>
                  );
                })}
              </div>
          ...
          {(task.attachments?.length > 0 || task.referenceLinks?.length > 0) && (
            <div>
              <p style={{ fontSize: "11px", fontWeight: 600, color: "#c4b5fd", margin: "0 0 8px", textTransform: "uppercase", letterSpacing: "0.05em" }}>Reference & Files</p>
                ...
                {(task.referenceLinks || []).map((link, i) => (
                  <a key={`legacy-${i}`} href={link} target="_blank" rel="noopener noreferrer"
                    style={{
                      ...
                      border: "1px solid rgba(196,181,253,0.15)", borderRadius: "10px",
        ...
        <div style={{
          ...
          {isAdmin && (
             ...
             onMouseEnter={e => { if(!loading) e.currentTarget.style.background = "#fff1f2"; }}
          ...
          {!isAdmin && !canEdit && (
             ...
             style={{
               ...
               color: "#9ca3af", cursor: "pointer", transition: "all 0.15s", fontFamily: "inherit",
             }}
           >
             Close
           </button>
